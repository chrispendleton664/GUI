function FailureLoad = GUILaminate_Orientation_TsaiHill(GUIInput)
...
TsaiHill = GUIFailLoadTsaiHill(theta, GUIInput);

FailureLoad(j+1,:) = [theta,TsaiHill.pt];
...
% Mmax = FailureLoad(:,:); 
    ...
    filename = 'LamApp Tsai-Hill Failure Results.xlsx';
